...
func (SortOrder) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_base_proto_enumTypes[0].Descriptor()
}

func (SortOrder) Type() protoreflect.EnumType {
	return &file_common_v1_base_proto_enumTypes[0]
}
...
func (SearchOperator) Descriptor() protoreflect.EnumDescriptor {
	return file_common_v1_base_proto_enumTypes[1].Descriptor()
}

func (SearchOperator) Type() protoreflect.EnumType {
	return &file_common_v1_base_proto_enumTypes[1]
}
...
type SortField struct {
	...
	Order SortOrder `protobuf:"varint,2,opt,name=order,proto3,enum=common.v1.SortOrder" json:"order,omitempty"` // 排序方式
}
...
func (x *PaginationResponse) Reset() {
	*x = PaginationResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_v1_base_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*PaginationResponse) Descriptor() ([]byte, []int) {
	return file_common_v1_base_proto_rawDescGZIP(), []int{3}
}
...
type SearchField struct {
	...
	Operator  SearchOperator `protobuf:"varint,4,opt,name=operator,proto3,enum=common.v1.SearchOperator" json:"operator,omitempty"` // 操作符
}

func (x *SearchField) Reset() {
	*x = SearchField{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_v1_base_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchField) Descriptor() ([]byte, []int) {
	return file_common_v1_base_proto_rawDescGZIP(), []int{4}
}
...
func (x *SearchRequest) Reset() {
	*x = SearchRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_v1_base_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SearchRequest) Descriptor() ([]byte, []int) {
	return file_common_v1_base_proto_rawDescGZIP(), []int{5}
}
...
func (x *VideoAuthor) Reset() {
	*x = VideoAuthor{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_v1_base_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*VideoAuthor) Descriptor() ([]byte, []int) {
	return file_common_v1_base_proto_rawDescGZIP(), []int{6}
}
...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_common_v1_base_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_common_v1_base_proto_rawDescGZIP(), []int{7}
}
...
var file_common_v1_base_proto_rawDesc = []byte{
	...
	0x31, 0x22, 0x6f, 0x0a, 0x08, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x12, 0x19, 0x0a,
	...
	0x6f, 0x6e, 0x22, 0x4d, 0x0a, 0x09, 0x53, 0x6f, 0x72, 0x74, 0x46, 0x69, 0x65, 0x6c, 0x64, 0x12,
	0x14, 0x0a, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05,
	0x66, 0x69, 0x65, 0x6c, 0x64, 0x12, 0x2a, 0x0a, 0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x18, 0x02,
	...
	0x72, 0x22, 0x65, 0x0a, 0x11, 0x50, 0x61, 0x67, 0x69, 0x6e, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52,
	...
	0x7a, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x12, 0x28,
	0x0a, 0x04, 0x73, 0x6f, 0x72, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x63,
	...
	0x74, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x8f,
	...
	,
	...
	0x08, 0x52, 0x0b, 0x69, 0x73, 0x46, 0x6f, 0x6c, 0x6c, 0x6f, 0x77, 0x69, 0x6e, 0x67, 0x22, 0xc9,
	...
	0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f,
	0x6e, 0x2e, 0x76, 0x31, 0x2e, 0x56, 0x69, 0x64, 0x65, 0x6f, 0x41, 0x75, 0x74, 0x68, 0x6f, 0x72,
	...
	,
...
var file_common_v1_base_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_common_v1_base_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_common_v1_base_proto_goTypes = []any{
	(SortOrder)(0),             // 0: common.v1.SortOrder
	(SearchOperator)(0),        // 1: common.v1.SearchOperator
	(*Metadata)(nil),           // 2: common.v1.Metadata
	(*SortField)(nil),          // 3: common.v1.SortField
	(*PaginationRequest)(nil),  // 4: common.v1.PaginationRequest
	(*PaginationResponse)(nil), // 5: common.v1.PaginationResponse
	(*SearchField)(nil),        // 6: common.v1.SearchField
	(*SearchRequest)(nil),      // 7: common.v1.SearchRequest
	(*VideoAuthor)(nil),        // 8: common.v1.VideoAuthor
	(*Video)(nil),              // 9: common.v1.Video
}
var file_common_v1_base_proto_depIdxs = []int32{
	0, // 0: common.v1.SortField.order:type_name -> common.v1.SortOrder
	3, // 1: common.v1.PaginationRequest.sort:type_name -> common.v1.SortField
	1, // 2: common.v1.SearchField.operator:type_name -> common.v1.SearchOperator
	6, // 3: common.v1.SearchRequest.search:type_name -> common.v1.SearchField
	8, // 4: common.v1.Video.author:type_name -> common.v1.VideoAuthor
...
func file_common_v1_base_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_common_v1_base_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_common_v1_base_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
	...
	out := protoimpl.TypeBuilder{
		...
		EnumInfos:         file_common_v1_base_proto_enumTypes,
