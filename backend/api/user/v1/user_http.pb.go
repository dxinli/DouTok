...
const OperationUserServiceBindUserVoucher = "/user.v1.UserService/BindUserVoucher"
const OperationUserServiceGetUserInfo = "/user.v1.UserService/GetUserInfo"
const OperationUserServiceGetVerificationCode = "/user.v1.UserService/GetVerificationCode"
const OperationUserServiceLogin = "/user.v1.UserService/Login"
const OperationUserServiceRegister = "/user.v1.UserService/Register"
const OperationUserServiceUnbindUserVoucher = "/user.v1.UserService/UnbindUserVoucher"
