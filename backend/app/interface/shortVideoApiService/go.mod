...
require (
	...
	github.com/cloudzenith/DouTok/backend/pkg v0.0.9
...
require (
	...
	github.com/cloudzenith/DouTok/backend/gopkgs v0.0.10 // indirect
...
replace github.com/cloudzenith/DouTok/backend/pkg v0.0.9 => ../../../pkg
